...
<!-- 
                ...
                <div class="container page__container">
                    <div class="d-md-flex  align-items-end justify-content-between">
                        <img src="assets/images/logo.png" alt="" width="600px" class="img-fluid">
                        <ol class="list-group">
                            <li class="list-group-item my-16pt mb-lg-48pt">
                                <div class="page-section">
                                    <form action="login" method="post" class="text-center">
                                        ...
                                        <!-- <br> -->
                                        <label for="Phone" class="mt-3">Admission Number</label>
                                        <input type="text" placeholder="Enter your admission number" name="password" class="text-center form-control" required>
                                        <!-- <br> -->
                                        <input type="submit" class="mt-3 btn btn-primary" value="Start Exam">
                                    </form>
                                </div>
                            </li>
                        </ol>
